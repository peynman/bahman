...
var (
	...
	loggerRef   core.Logger
)

func Initialize(config core.Config, logger core.Logger) (core.Repository, core.Migrator) {
	loggerRef = logger
...
func initDatabase(config core.Config, keyPrefix string) *gorm.DB {
...
func openSqlite3(config core.Config, configPath string) *gorm.DB {
...
func openMySQL(config core.Config, configPath string) *gorm.DB {
