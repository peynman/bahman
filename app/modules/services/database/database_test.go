...
func (t *TestMigratable1) Up(migrator services.Migrator) error {
	var err error
...
func (t *TestMigratable1) Down(migrator services.Migrator) error {
	var err error
...
func (t *TestMigratable0) Up(migrator services.Migrator) error {
	var err error
...
func (t *TestMigratable0) Down(migrator services.Migrator) error {
	var err error
