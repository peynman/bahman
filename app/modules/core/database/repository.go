...
var _ core.Repository = (*RepositoryManager)(nil)

func (r *RepositoryManager) Query(entity core.Entity) core.QueryBuilder {
	var db *gorm.DB
	conn, ok := entity.(core.EntityConnection)
	if ok {
...
func (r *RepositoryManager) Insert(entity core.Entity) error {
	var db *gorm.DB
	if conn, ok := entity.(core.EntityConnection); ok {
		db = connections[conn.ConnectionName()]
		if db != nil {
			db = db.Table(entity.TableName())
		}
...
func (r *RepositoryManager) UpdateEntity(entity core.Entity) error {
	var db *gorm.DB
	if conn, ok := entity.(core.EntityConnection); ok {
		db = connections[conn.ConnectionName()]
		if db != nil {
...
func (r *RepositoryManager) DeleteEntity(entity core.Entity) error {
	var db *gorm.DB
	if conn, ok := entity.(core.EntityConnection); ok {
		db = connections[conn.ConnectionName()]
		if db != nil {
...
func (r *RepositoryManager) EraseEntity(entity core.Entity) error {
	var db *gorm.DB
	if conn, ok := entity.(core.EntityConnection); ok {
		db = connections[conn.ConnectionName()]
		if db != nil {
...
func (r *RepositoryManager) Reset() core.QueryBuilder {
	r.db = r.query
	r.includeDeletes = false
	return r
}

func (r *RepositoryManager) IncludeDeleted() core.QueryBuilder {
	r.db = r.db.Unscoped()
	r.includeDeletes = true
	return r
}

func (r *RepositoryManager) Where(query interface{}, args ...interface{}) core.QueryBuilder {
	r.db = r.db.Where(query, args)
	return r
}

func (r *RepositoryManager) Select(query interface{}, args ...interface{}) core.QueryBuilder {
	r.db = r.db.Select(query, args)
	return r
}

func (r *RepositoryManager) Limit(limit interface{}) core.QueryBuilder {
	r.db = r.db.Limit(limit)
	return r
}

func (r *RepositoryManager) Offset(offset interface{}) core.QueryBuilder {
	r.db = r.db.Offset(offset)
	return r
}

func (r *RepositoryManager) Order(value interface{}) core.QueryBuilder {
	r.db = r.db.Order(value)
	return r
}

func (r *RepositoryManager) OrWhere(query interface{}, args ...interface{}) core.QueryBuilder {
