...
func (m *MigrationManager) AutoMigrate(entity core.Entity) error {
...
func (m *MigrationManager) CreateTable(entity core.Entity) error {
...
func (m *MigrationManager) Migrate(migrates []core.Migratable) error {
	return m.migrate(m.connection, migrates)
}

func (m *MigrationManager) Rollback(migrates []core.Migratable) error {
	return m.rollback(m.connection, migrates)
}

func (m *MigrationManager) Connection(connection string) core.Migrator {
...
func (m *MigrationManager) migrate(connection *gorm.DB, migrates []core.Migratable) error {
...
func (m *MigrationManager) rollback(connection *gorm.DB, migrates []core.Migratable) error {
	var migrations []*MigrationModel
	var migratableInterfaces []string
...
func getMigration(migrations []*MigrationModel, migratable core.Migratable) *MigrationModel {
