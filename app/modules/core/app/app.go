...
func (a *appImpl) InitAvalanchePlugins(path string, services core.Services) []core.AvalanchePlugin {
	...
	var modules []core.AvalanchePlugin
	for _, moduleFile := range moduleFiles {
		...
		pluginInstance := *pluginInstanceRef.(*core.AvalanchePlugin)
