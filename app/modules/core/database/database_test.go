...
func (t *TestMigratable1) Up(migrator core.Migrator) error {
	var err error
...
func (t *TestMigratable1) Down(migrator core.Migrator) error {
	var err error
...
func (t *TestMigratable0) Up(migrator core.Migrator) error {
	var err error
...
func (t *TestMigratable0) Down(migrator core.Migrator) error {
	var err error
...
func TestMigrations(t *testing.T) {
	...
	if err = mig.Migrate([]core.Migratable{
		new(TestMigratable0),
	}); err != nil {
		t.Error(err)
	}
	...
	if err = mig.Rollback([]core.Migratable{
		new(TestMigratable1),
	}); err != nil {
		t.Error(err)
	}
